package com.jn.bktravels.globalexceptions;
...
import com.jn.bktravels.dtos.CustomMessage;
 ...
 * </p>
 *
 * @see com.jn.bktravels.dtos.CustomMessage
 * @see ResponseEntity
 */
...
//    }
    ...
    public ResponseEntity<?> handleMethodArgumentTypeMismatchException(org.springframework.web.method.annotation.MethodArgumentTypeMismatchException ex) {
        CustomMessage errorResponse = new CustomMessage("Please check the type of the parameters you have passed"+ex);
    ...
    public ResponseEntity<?> handleInvalidFormatException(com.fasterxml.jackson.databind.exc.InvalidFormatException ex) {
        HashMap<String, String> errors = new HashMap<>();
        errors.put(ex.getPath().getFirst().getFieldName(), "Invalid format");
        return ResponseEntity.badRequest().body(errors);
    }
...
//    }
    ...
    public ResponseEntity<?> handleHttpMessageNotReadableException(org.springframework.http.converter.HttpMessageNotReadableException ex) {
        return ResponseEntity.badRequest().body(new CustomMessage("Please check the type of the parameters you have passed"+ex));
    }
    ...
    public ResponseEntity<?> handleUnexpectedTypeException(UnexpectedTypeException ex) {
        HashMap<String, String> errors = new HashMap<>();
        errors.put("message", "Please check the type of the parameters you have passed"+ex);
